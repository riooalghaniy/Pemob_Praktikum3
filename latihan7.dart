        ...
        body: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Container(
                  margin: const EdgeInsets.only(left: 10, top: 25), // Mengatur jarak atas
                  child: const Text(
                    'Your Favorites',
                ...
                Container(
                  margin: const EdgeInsets.only(right: 10, bottom: 10), // Mengatur jarak bawah
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  _buildMenuRow([
                    _buildMenuItem('GoRide', 'assets/goride.jpg', 'GoRide'),
                  ...
                  _buildMenuRow([
                    ...
                    _buildMenuItem('GoTagihan', 'assets/gotagihan.jpg', 'GoTagihan'),
                    _buildMenuItem(
                        'GoShop', 'assets/goshop.jpg', 'GoShop'),
                    _buildMenuItem(
                        'Lainnya', 'assets/lainnya.jpg', 'Lainnya'),
                  ]),
                ],
              ),
            ),
